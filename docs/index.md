...
- [Workflow semantics](reference/workflow-semantics.md) defines Role, Script, and Human leaf execution; Sequential, Loop, and Router composition; node input and output; state updates; edge-authorized Loop escalation; failure; REPL control; and lifecycle behavior.
