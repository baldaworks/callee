...
kind: Role
spec:
  description: Turn natural-language feature or project descriptions into structured requirements with REQ-IDs, acceptance criteria, and traceability.
  repl: true
  provider:
    type: codex
  params:
...
PromptKit parameter `context` — Additional context — existing system, constraints, stakeholders:
